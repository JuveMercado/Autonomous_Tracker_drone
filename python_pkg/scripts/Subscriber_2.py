...
if __name__ == '__main__':
    try:
        ...
        rospy.Subscriber('/q2/real/image_raw', Image, vision_callback, queue_size=1, buff_size=2**24)
        rospy.Subscriber('/q2/real/fix', NavSatFix, gps_callback, queue_size=1, buff_size=2**24)
        while(True):
